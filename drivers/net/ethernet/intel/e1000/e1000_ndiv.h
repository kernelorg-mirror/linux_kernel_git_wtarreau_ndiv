...
static inline
int e1000_ndiv_handle_rx(struct ndiv *ndiv, struct e1000_rx_ring *rx_ring, struct e1000_tx_ring *tx_ring, struct e1000_buffer *rx_buffer, struct e1000_rx_desc *rx_desc)
{
	struct e1000_ndiv_rdesc *packet;
	u8 *out = NULL;
	int ret = 0;
